...
d));this._newModal(this.dom.removeTitle,this.s.dt.i18n("stateRestore.removeSubmit",this.c.i18n.removeSubmit),a,this.dom.removeContents)}};n.prototype.destroy=function(){for(var a=0,c=this.s.states;a<c.length;a++)c[a].destroy();Object.values(this.dom).forEach(function(d){d.off();d.remove()});this.s.states=[];this.s.dt.off(".dtsr");m(this.s.dt.table().node()).off(".dtsr")};n.prototype.getState=function(a){for(var c=0,d=this.s.states;c<d.length;c++){var e=d[c];if(e.s.identifier===a)return e}return null};
n.prototype.getStates=function(a){if(void 0===a)return this.s.states;for(var c=[],d=0;d<a.length;d++){for(var e=a[d],l=!1,b=0,f=this.s.states;b<f.length;b++){var h=f[b];if(e===h.s.identifier){c.push(h);l=!0;break}}l||c.push(void 0)}return c};n.prototype._addPreDefined=function(a){for(var c=this,d=function(f){for(var h=0;h<e.s.states.length;h++)e.s.states[h].s.identifier===f&&e.s.states.splice(h,1);h=a[f];var r=new u(e.s.dt,m.extend(!0,{},e.c,void 0!==h.c?{saveState:h.c.saveState}:void 0,!0),f,h,!0);
r.s.savedState=h;e.s.states.push(r);m(e.s.dt.table().node()).on("dtsr-modal-inserted",function(){r.dom.confirmation.one("dtsr-remove",function(){return c._removeCallback(r.s.identifier)});r.dom.confirmation.one("dtsr-rename",function(){return c._collectionRebuild()});r.dom.confirmation.one("dtsr-save",function(){return c._collectionRebuild()})})},e=this,l=0,b=Object.keys(a).sort(function(f,h){f=+c._getId(f);h=+c._getId(h);return f>h?1:f<h?-1:0});l<b.length;l++)d(b[l]);this._collectionRebuild()};n.prototype._collectionRebuild=
function(){var a=this,c=[];this.c._createInSaved&&c.push("createState");if(0===this.s.states.length)c.push('<span class="'+this.classes.emptyStates+'">'+this.s.dt.i18n("stateRestore.emptyStates",this.c.i18n.emptyStates)+"</span>");else{this.s.states=this.s.states.sort(function(f,h){f=+a._getId(f.s.identifier);h=+a._getId(h.s.identifier);return f>h?1:f<h?-1:0});for(var d=0,e=this.s.states;d<e.length;d++){var l=e[d],b=[];this.c.save&&l.c.save&&b.push("updateState");this.c.save&&l.c.save&&this.c.rename&&
l.c.rename&&b.push("renameState");this.c.remove&&l.c.remove&&b.push("removeState");0<b.length&&b.unshift("<h3>"+l.s.identifier+"</h3>");c.push({_stateRestore:l,config:{split:b},extend:"stateRestore",text:l.s.identifier})}}this.s.dt.button("SaveStateRestore:name").collectionRebuild(c)};n.prototype._creationModal=function(a,c,d){var e=this;this.dom.creation.empty();this.dom.creationForm.empty();this.dom.nameInputRow.children("input").val(c);this.dom.creationForm.append(this.dom.nameInputRow);var l=
this.s.dt.settings()[0].oInit;c=[];var b=void 0!==d&&void 0!==d.toggle;((!b||void 0===d.toggle.order)&&this.c.toggle.order||b&&d.toggle.order)&&this.c.saveState.order&&(void 0===l.ordering||l.ordering)&&c.push(this.dom.orderToggle);((!b||void 0===d.toggle.search)&&this.c.toggle.search||b&&d.toggle.search)&&this.c.saveState.search&&(void 0===l.searching||l.searching)&&c.push(this.dom.searchToggle);((!b||void 0===d.toggle.paging)&&this.c.toggle.paging||b&&d.toggle.paging)&&this.c.saveState.paging&&
...
c.push(this.dom.columnsVisibleToggle)));c.sort(function(q,v){q=q.children("label.dtsr-check-label")[0].innerHTML;v=v.children("label.dtsr-check-label")[0].innerHTML;return q<v?-1:q>v?1:0});for(l=0;l<c.length;l++)d=c[l],this.dom.creationForm.append(d);m(this.dom.creationForm.children("div."+this.classes.checkRow)[0]).prepend(this.dom.toggleLabel);this.dom.background.appendTo(this.dom.dtContainer);this.dom.creation.append(this.dom.creationTitle).append(this.dom.creationForm).append(this.dom.createButtonRow).appendTo(this.dom.dtContainer);
m(this.s.dt.table().node()).trigger("dtsr-modal-inserted");l=function(q){m(q.children("label:last-child")).on("click",function(){q.children("input").prop("checked",!q.children("input").prop("checked"))})};for(b=0;b<c.length;b++)d=c[b],l(d);var f=m("button."+this.classes.creationButton.replace(/ /g,"."));c=this.dom.creationForm.find("input");0<c.length?m(c[0]).focus():f.focus();var h=m("div."+this.classes.background.replace(/ /g,".")),r=function(q){"Enter"===q.key?f.click():"Escape"===q.key&&h.click()};
f.on("click",function(){var q={colReorder:e.dom.colReorderToggle.children("input").is(":checked"),columns:{search:e.dom.columnsSearchToggle.children("input").is(":checked"),visible:e.dom.columnsVisibleToggle.children("input").is(":checked")},order:e.dom.orderToggle.children("input").is(":checked"),paging:e.dom.pagingToggle.children("input").is(":checked"),scroller:e.dom.scrollerToggle.children("input").is(":checked"),search:e.dom.searchToggle.children("input").is(":checked"),searchBuilder:e.dom.searchBuilderToggle.children("input").is(":checked"),
searchPanes:e.dom.searchPanesToggle.children("input").is(":checked"),select:e.dom.selectToggle.children("input").is(":checked")};q=a(m("input."+e.classes.nameInput.replace(/ /g,".")).val(),{saveState:q});!0===q?(e.dom.background.remove(),e.dom.creation.remove(),m(document).unbind("keyup",r)):(e.dom.creation.children("."+e.classes.modalError).remove(),e.dom.creation.append(e.dom[q+"Error"]))});h.one("click",function(){e.dom.background.remove();e.dom.creation.remove();m(document).unbind("keyup",r);
e._collectionRebuild()});m(document).on("keyup",r);this.s.dt.state.save()};n.prototype._findActive=function(){this.s.dt.state.save();var a=this.s.dt.state(),c=m("button."+m.fn.DataTable.Buttons.defaults.dom.button.className.replace(/ /g,"."));0===c.length&&(c=m("a."+m.fn.DataTable.Buttons.defaults.dom.button.className.replace(/ /g,".")));for(var d=0,e=c;d<e.length;d++){var l=e[d];this.s.dt.button(m(l).parent()[0]).active(!1)}d=0;for(e=this.s.states;d<e.length;d++){var b=e[d];if(b.compare(a))for(var f=
0,h=c;f<h.length;f++)if(l=h[f],m(l).text()===b.s.identifier){this.s.dt.button(m(l).parent()[0]).active(!0);break}}};n.prototype._removeCallback=function(a){for(var c=0;c<this.s.states.length;c++)this.s.states[c].s.identifier===a&&(this.s.states.splice(c,1),c--);this._collectionRebuild();return!0};n.prototype._getId=function(a){var c=this.s.dt.settings()[0].oLanguage;c=void 0!==c.buttons&&void 0!==c.buttons.stateRestore?c.buttons.stateRestore:"State ";if(c.indexOf("%d")===c.length-3)c=new RegExp(c.replace(/%d/g,
""));else{var d=c.split("%d");c=[];for(var e=0;e<d.length;e++)c.push(new RegExp(d[e]))}if(Array.isArray(c))for(d=a,e=0;e<c.length;e++)d=d.replace(c[e],"");else d=a.replace(c,"");return isNaN(+d)||d.length===a?0:+d};n.prototype._newModal=function(a,c,d,e){var l=this;this.dom.background.appendTo(this.dom.dtContainer);this.dom.confirmationTitleRow.empty().append(a);var b=m('<button class="'+this.classes.confirmationButton+" "+this.classes.dtButton+'">'+c+"</button>");this.dom.confirmation.empty().append(this.dom.confirmationTitleRow).append(e).append(m('<div class="'+
this.classes.confirmationButtons+'"></div>').append(b)).appendTo(this.dom.dtContainer);m(this.s.dt.table().node()).trigger("dtsr-modal-inserted");a=e.children("input");0<a.length?m(a[0]).focus():b.focus();var f=m("div."+this.classes.background.replace(/ /g,".")),h=function(r){"Enter"===r.key?b.click():"Escape"===r.key&&f.click()};b.on("click",function(){var r=d(!0);!0===r?(l.dom.background.remove(),l.dom.confirmation.remove(),m(document).unbind("keyup",h),b.off("click")):(l.dom.confirmation.children("."+
l.classes.modalError).remove(),l.dom.confirmation.append(l.dom[r+"Error"]))});this.dom.confirmation.on("click",function(r){r.stopPropagation()});f.one("click",function(){l.dom.background.remove();l.dom.confirmation.remove();m(document).unbind("keyup",h)});m(document).on("keyup",h)};n.prototype._searchForStates=function(){for(var a=this,c=function(b){if(b.match(new RegExp("^DataTables_stateRestore_.*_"+location.pathname.replace(/\//g,"/")+"$"))){b=JSON.parse(localStorage.getItem(b));if(b.stateRestore.isPreDefined)return"continue";
...
module.exports=function(a,c){a||(a=window);c&&c.fn.dataTable||(c=require("datatables.net")(a,c).$);return n(c,a,a.document)}:n(window.jQuery,window,document)})(function(n,a,c){function d(b,f){f=new n.fn.dataTable.StateRestoreCollection(b,f.config);e(b,f)}function e(b,f){var h=b.stateRestore.states(),r=[],q=b.settings()[0]._stateRestore.c;q._createInSaved&&r.push("createState");if(void 0===h||0===h.length)r.push('<span class="'+f.classes.emptyStates+'">'+b.i18n("stateRestore.emptyStates",f.c.i18n.emptyStates)+
"</span>");else for(f=0;f<h.length;f++){var v=h[f],z=[];q.save&&z.push("updateState");q.save&&q.rename&&z.push("renameState");q.remove&&z.push("removeState");0<z.length&&z.unshift("<h3>"+v.s.identifier+"</h3>");r.push({_stateRestore:v,config:{split:z},extend:"stateRestore",text:v.s.identifier})}b.button("SaveStateRestore:name").collectionRebuild(r)}k(n);p(n);var l=n.fn.dataTable;n.fn.dataTable.StateRestore=u;n.fn.DataTable.StateRestore=u;n.fn.dataTable.StateRestoreCollection=C;n.fn.DataTable.StateRestoreCollection=
C;a=n.fn.dataTable.Api.register;a("stateRestore()",function(){return this});a("stateRestore.state()",function(b){var f=this.context[0];if(!f._stateRestore){var h=n.fn.DataTable.Api(f),r=new n.fn.dataTable.StateRestoreCollection(h,{});e(h,r)}this[0]=f._stateRestore.getState(b);return this});a("stateRestore.state.add()",function(b,f){var h=this.context[0];if(!h._stateRestore){var r=n.fn.DataTable.Api(h),q=new n.fn.dataTable.StateRestoreCollection(r,{});e(r,q)}if(!h._stateRestore.c.create)return this;
if(h._stateRestore.addState){r=[];q=0;for(var v=h._stateRestore.s.states;q<v.length;q++)r.push(v[q].s.identifier);h._stateRestore.addState(b,r,f);return this}});a("stateRestore.states()",function(b){var f=this.context[0];if(!f._stateRestore){var h=n.fn.DataTable.Api(f),r=new n.fn.dataTable.StateRestoreCollection(h,{});e(h,r)}this.length=0;this.push.apply(this,f._stateRestore.getStates(b));return this});a("stateRestore.state().save()",function(){var b=this[0];b.c.save&&b.save();return this});a("stateRestore.state().rename()",
function(b){var f=this.context[0],h=this[0];if(h.c.save){var r=[],q=0;for(f=f._stateRestore.s.states;q<f.length;q++)r.push(f[q].s.identifier);h.rename(b,r)}return this});a("stateRestore.state().load()",function(){this[0].load();return this});a("stateRestore.state().remove()",function(b){var f=this[0];f.c.remove&&f.remove(b);return this});a("stateRestore.states().remove()",function(b){var f=this,h=function(r){var q=!0;f.each(function(v){void 0!==v&&v.c.remove&&(v=v.remove(r),!0!==v&&(q=v))});return q};
this.context[0]._stateRestore.c.remove&&(b?h(b):this.context[0]._stateRestore.removeAll(h));return this});n.fn.dataTable.ext.buttons.stateRestore={action:function(b,f,h,r){r._stateRestore.load();h.blur()},config:{split:["updateState","renameState","removeState"]},text:function(b){return b.i18n("buttons.stateRestore","State %d",b.stateRestore.states()[0].length+1)}};n.fn.dataTable.ext.buttons.updateState={action:function(b,f,h,r){n("div.dt-button-background").click();r.parent._stateRestore.save()},
text:function(b){return b.i18n("buttons.updateState","Update")}};n.fn.dataTable.ext.buttons.savedStates={buttons:[],extend:"collection",init:function(b,f,h){void 0===b.settings()[0]._stateRestore&&d(b,h)},name:"SaveStateRestore",text:function(b){return b.i18n("buttons.savedStates","Saved States")}};n.fn.dataTable.ext.buttons.savedStatesCreate={buttons:[],extend:"collection",init:function(b,f,h){void 0===b.settings()[0]._stateRestore&&(void 0===h.config&&(h.config={}),h.config._createInSaved=!0,d(b,
h))},name:"SaveStateRestore",text:function(b){return b.i18n("buttons.savedStates","Saved States")}};n.fn.dataTable.ext.buttons.createState={action:function(b,f,h,r){b.stopPropagation();b=f.settings()[0]._stateRestore.c;var q=f.settings()[0].oLanguage;if(b.create&&b.save){var v=f.stateRestore.states().toArray();q=void 0!==q.buttons&&void 0!==q.buttons.stateRestore?q.buttons.stateRestore:"State ";if(q.indexOf("%d")===q.length-3)var z=new RegExp(q.replace(/%d/g,""));else{var B=q.split("%d");z=[];for(var A=
0;A<B.length;A++)q=B[A],z.push(new RegExp(q))}var E=function(y){if(Array.isArray(z)){var x=y;for(var D=0,F=z;D<F.length;D++)x=x.replace(F[D],"")}else x=y.replace(z,"");return isNaN(+x)||x.length===y?0:+x};q=v.map(function(y){return E(y.s.identifier)}).sort(function(y,x){return+y<+x?1:+y>+x?-1:0})[0];f.stateRestore.state.add(f.i18n("buttons.stateRestore","State %d",void 0!==q?q+1:1),r.config);r=f.stateRestore.states().sort(function(y,x){y=+E(y.s.identifier);x=+E(x.s.identifier);return y>x?1:y<x?-1:
0});v=[];b._createInSaved&&(v.push("createState"),v.push(""));for(B=0;B<r.length;B++)A=r[B],q=[],b.save&&q.push("updateState"),b.save&&b.rename&&q.push("renameState"),b.remove&&q.push("removeState"),0<q.length&&q.unshift("<h3>"+A.s.identifier+"</h3>"),v.push({_stateRestore:A,config:{split:q},extend:"stateRestore",text:A.s.identifier});f.button("SaveStateRestore:name").collectionRebuild(v);h.blur()}},init:function(b,f,h){void 0===b.settings()[0]._stateRestore&&1<b.button("SaveStateRestore:name").length&&
d(b,h)},text:function(b){return b.i18n("buttons.createState","Create State")}};n.fn.dataTable.ext.buttons.removeState={action:function(b,f,h,r){r.parent._stateRestore.remove();h.blur()},text:function(b){return b.i18n("buttons.removeState","Remove")}};n.fn.dataTable.ext.buttons.removeAllStates={action:function(b,f,h){f.stateRestore.states().remove(!0);h.blur()},text:function(b){return b.i18n("buttons.removeAllStates","Remove All States")}};n.fn.dataTable.ext.buttons.renameState={action:function(b,
f,h,r){b=[];var q=0;for(f=f.settings()[0]._stateRestore.s.states;q<f.length;q++)b.push(f[q].s.identifier);r.parent._stateRestore.rename(void 0,b);h.blur()},text:function(b){return b.i18n("buttons.renameState","Rename")}};n(c).on("preInit.dt.dtsr",function(b,f){"dt"!==b.namespace||!f.oInit.stateRestore&&!l.defaults.stateRestore||f._stateRestore||(b=null,void 0===b&&(b=null),f=new l.Api(f),b=b?b:f.init().stateRestore||l.defaults.stateRestore,b=new C(f,b),e(f,b))})})})();
